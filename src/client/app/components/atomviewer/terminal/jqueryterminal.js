(function() {
    ...
    angular
        .module('components.atomviewer.terminal')
        ...
        function jqueryTerminal() {
            ...
            function link(scope, elem, attrs) {
                ...
                var term_options = {
                    greetings:"[[b;white;black]AtomSpace Viewer Command Line]",
                    prompt: '[[b;yellow;black]>]',
                    name: 'test'
                };

                var terminal = $('#terminalText').terminal(treatCommand, term_options);
            }

            function treatCommand(command, term)  {
